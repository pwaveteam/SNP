...
const newRow:DataRow={id:newId,title:item.title,author:item.author,date:item.date,views:0,fileAttach:item.fileAttach}
...
{modalOpen&&(
<NoticeRegister isOpen onClose={()=>setModalOpen(false)}onSave={handleSave}userName="관리자"/>
)}
</section>
)
}